      ...
      <div className="max-w-7xl mx-auto space-y-6 cat-page-enter">
        ...
        <div className="cat-page-header flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex gap-2">
            <div className="cat-badge cat-badge-overdue text-xs px-3 py-1 font-mono font-bold">
              <AlertTriangle className="w-3 h-3 inline mr-1" />
              {overdue.length} OVERDUE
            </div>
            <div className="cat-badge cat-badge-maintenance text-xs px-3 py-1 font-mono font-bold">
